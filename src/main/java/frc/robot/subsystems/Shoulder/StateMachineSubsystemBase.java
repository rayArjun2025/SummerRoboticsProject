...
// Raymond: delete this whole file. there's already a shared StateMachineSubsystemBase in
// frc.robot.util that Climber and Hand extend - a second copy living in the shoulder package means
// two different base classes floating around the codebase. point Shoulder at
// frc.robot.util.StateMachineSubsystemBase instead. on top of that this copy is missing the timer
