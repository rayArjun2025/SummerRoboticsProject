...
public class ShoulderConstants {
    ...
    // Raymond: 2.5 FF can live here, but the stuff still hardcoded in the other files belongs here too - kP/kI/kD, the 1.0 tolerance, the 50hz update rate, and the motor current limits (we run 60 supply / 82 stator).
    ...
    // Raymond: CAN id 1 is a placeholder and it'll collide with other subsystems' motors on the bus. set the real id.
