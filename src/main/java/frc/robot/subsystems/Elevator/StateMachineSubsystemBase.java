...
// Raymond: this is a duplicate of the shared base. there's one StateMachineSubsystemBase in
// subsystems/ that everything extends - delete this copy and have Elevator extend that one. on top
// of being a dup, this copy is missing the MTimer/timer the real base has (timer.reset() in
// queueState, the StateTimer log in periodic), so any state that needs timing won't work. one base,
// no forks.
